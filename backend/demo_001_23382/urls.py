"""demo_001_23382 URL Configuration
...
admin.site.site_header = "Demo-001"
admin.site.site_title = "Demo-001 Admin Portal"
admin.site.index_title = "Demo-001 Admin"

# swagger
api_info = openapi.Info(
    title="Demo-001 API",
    default_version="v1",
    description="API documentation for Demo-001 App",
)
